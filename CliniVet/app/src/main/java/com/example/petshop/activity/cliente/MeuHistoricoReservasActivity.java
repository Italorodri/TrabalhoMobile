...
public class MeuHistoricoReservasActivity extends AppCompatActivity implements AdapterReservas.OnClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meu_historico_reservas);
        iniciaComponentes();
        configRv();
        configCliques();
        recuperaReservas();
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    text_info.setText("Nenhuma reserva encontrada.");
                }
    ...
    private  void iniciaComponentes(){
        ...
        text_titulo.setText("Meu Histórico de Reservas");
    }
